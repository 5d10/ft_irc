...
Simply running make in the root directory should compile the project and put the executable right there.
In order tu run it, give it a port and a password as arguments in that order. You can also use 'make run', just remember to change the password on the makefile, it's at the end.
